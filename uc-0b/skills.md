skills:
  ...
  - name: summarize_policy
    ...
    input: Structured text or JSON containing numbered sections of the policy document.
    output: A compliant summary text preserving all obligations, conditions, and clause references.
